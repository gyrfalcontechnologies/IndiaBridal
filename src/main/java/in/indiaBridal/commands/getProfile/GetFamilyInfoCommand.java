...
public class GetFamilyInfoCommand extends DBConnectionHandler 
{
	final static Logger logger = Logger.getLogger(GetFamilyInfoCommand.class);
	ArrayList<String> keyList = new ArrayList<String>();
	HashMap<String, String> usrFDetails = new HashMap<String, String>();
	...
	public HashMap<String, Object> getResponseJSON(String memberID)
	{
		...
		if(!Utilities.isNullOrEmpty(nextPageResMap))
		{
			if("success".equalsIgnoreCase((String) nextPageResMap.get("status")))
			{
				...
				{
					responseMap.put("navPage", "familyInfo");
	...
	public HashMap<String, Object> getResponseHashMap(String memberID)
	{
		...
		GetUserFamilyDetailsCommand getUsrFDetObj = new GetUserFamilyDetailsCommand();
		HashMap<String, Object> usrFDetResMap = getUsrFDetObj.getResponseHashMap(memberID);

		if(!Utilities.isNullOrEmpty(usrFDetResMap))
		{
			if("success".equalsIgnoreCase((String) usrFDetResMap.get("status")))
			{
				usrFDetails = (HashMap<String, String>) usrFDetResMap.get("userData");
	...
	public HashMap<String, Object> generateDataResponse()
	{
		...
		Set<String> userDataRemKeys = usrFDetails.keySet();
	...
	public String getSelectStmt(String currSel)
	{
		...
		{
			if("country".equalsIgnoreCase(currSel))
			{
	...
	{
		String userValue = usrFDetails.get(keyName+"ID");
		usrFDetails.remove(keyName+"ID");
	...
	{
		String userValue = usrFDetails.get(keyName);
